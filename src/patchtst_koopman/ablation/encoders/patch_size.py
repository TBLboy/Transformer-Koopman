"""Ablation variant: configurable patch length."""
import torch
...
class PatchSizeAblationEncoder(nn.Module):
    """PatchTST encoder with overridable patch length."""

    def __init__(self, config, patch_length=None):
        super().__init__()
        ...
        self.patch_length = patch_length or config["encoder"]["patch_length"]
