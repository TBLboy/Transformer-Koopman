"""
Train PatchTST-Koopman on Platform 2 (2-DOF Soft Robotic Arm).

Usage:
    python scripts/train_platform2.py
"""
...
def main():
    ...
    print("=" * 60)
    print("  PatchTST-Koopman Training — Platform 2")
    ...
    log_abs = LOGS_DIR / "p2_patchtst_koopman.log"
    ...
    print(f"  Platform 2  {status}  ({elapsed:.0f}s)")
